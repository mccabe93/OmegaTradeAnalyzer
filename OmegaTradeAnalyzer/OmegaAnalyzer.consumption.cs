...
namespace OmegaTradeAnalyzer
{
    ...
    {
        /// <summary>
        /// model input class for OmegaAnalyzer.
        /// </summary>
        ...
        public class ModelInput
        {
            ...
            public float OpeningVIX { get; set; }

            [LoadColumn(4)]
            [ColumnName(@"MostOTM")]
            public float MostOTM { get; set; }

            [LoadColumn(5)]
            [ColumnName(@"LeastOTM")]
            public float LeastOTM { get; set; }

            [LoadColumn(6)]
            [ColumnName(@"AverageOTM")]
            public float AverageOTM { get; set; }
        ...
        /// <summary>
        /// model output class for OmegaAnalyzer.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"Profitable")]
            public uint Profitable { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("OmegaAnalyzer.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Profitable");
            if (labelColumn == null)
            {
                throw new Exception("Profitable column not found. Make sure the name searched for matches the name in the schema.");
            }
